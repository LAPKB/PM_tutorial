...
The plot can appear more jagged with smaller bin sizes because different subjects have
...
npc_2
```
 ...and here is a numerical predictive check. P-values are binomial test of proportion of observations less than
