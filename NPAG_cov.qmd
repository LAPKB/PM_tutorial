...
1. We used `r gh_help("model_lib")` to check the name of the algebraic 3-compartment model and the required parameters that should be declared (Ka, Ke, K23, K24, K32, K42 and V).
